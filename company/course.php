            ...
            ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-3 mx-3 d-grid gap-2">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="update-course.php?id=<?php echo $row['id_course'] ?>" class="btn btn-success btn-lg">Update</a>
                                    <a href="delete-course.php?id=<?php echo $row['id_course'] ?>" class="btn btn-danger btn-lg">Delete</a>
                                </div>
                            </div>
                        </div>
                    </div> <?php
