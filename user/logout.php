<div class="modal fade" id="loginModal" tabindex="-1" aria-labelledby="feedbackModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body border-0 p-3 py-2">
                <div class="d-grid"><button class="btn btn-success rounded-pill btn-lg" name="profile" type="button" data-bs-dismiss="modal" aria-label="Close" onclick="window.location.href='my_courses.php'">My Courses</button>
                </div>
            </div>
            <div class="modal-body border-0 p-3 pt-0">
